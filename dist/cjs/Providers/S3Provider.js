    ...
    constructor(options) {
        ...
        if (options._commands) {
            ...
            try {
                ...
                throw new HlsStreamerErrors_1.StorageProviderError('@aws-sdk/client-s3 is not installed. Run: npm install @aws-sdk/client-s3', this.resourceId);
            }
        }
    ...
    async getSize() {
        try {
            ...
            if (res.ContentLength === undefined) {
                throw new HlsStreamerErrors_1.StorageProviderError('Could not determine object size', this.resourceId);
            }
            return res.ContentLength;
        }
        catch (err) {
            if (err instanceof HlsStreamerErrors_1.StorageProviderError)
                throw err;
            throw new HlsStreamerErrors_1.StorageProviderError(err.message, this.resourceId);
        }
    }
